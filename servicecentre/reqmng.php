...
?>
	...
	<!-- end #header -->
		...
		<div style="clear: both;">
        			<div class="post">
     <br>  
   <div  style="font-size:22px; color:#000" align="center">Заявки клиентoв  (режим менеджера)</div>
      <br>  
...
$s=$s." order by $fieldsort";
	 ...
	 ?>
     		...
     		<div align="right">	
Сортировка:
				<select name="sortname"  style="height:22; width:auto" onChange="this.form.action='reqmng.php?sort=1&filter=<? echo $filter;?>'; this.form.submit();" >
...
по полю 
 &nbsp;  
				...
				<br>
				<input  type="button"  name="button1"  onclick="this.form.action='reqmng.php?filter=1&sort=<? echo $sort;?>'; this.form.submit();"   value="Фильтр">
				<input  type="button"  name="button2"  onclick="this.form.action='reqmng.php?filter=0&sort=<? echo $sort;?>'; this.form.submit();"   value="Очистить">
           <br>            
        </div>   
<?
 $r=mysql_query($s);
?>
 ...
 <input  type="button"  name="button4" <? if (mysql_num_rows($r)==0) {?>    disabled="disabled"<? }?>   onclick="this.form.action='updreqmng.php?upd=1&step=1'; this.form.submit();" value="Редактирование"> 
 <input  type="button"  name="button" <? if (mysql_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="qwest=window.confirm('Вы действительно хотите удалить запись?');  if (qwest) {this.form.action='delrequest.php'; this.form.submit();}" value="Удалить">    
 &nbsp; &nbsp; &nbsp;
   <input  type="button"  name="button4" <? if (mysql_num_rows($r)==0) {?>    disabled="disabled"<? }?>   onclick="this.form.action='client.php'; this.form.submit();" value="Информация о клиенте"> 
  <input  type="button"  name="button4" <? if (mysql_num_rows($r)==0) {?>    disabled="disabled"<? }?>   onclick="this.form.action='worker.php'; this.form.submit();" value="Информация о исполнителе">    
 &nbsp; &nbsp; &nbsp;
  <input  type="button"  name="button4" <? if (mysql_num_rows($r)==0) {?>    disabled="disabled"<? }?>   onclick="this.form.action='servicing.php'; this.form.submit();" value="Корзина"> 
  ...
  <table WIDTH=100% border=4  bordercolor="grey" cellspacing=0 cellpadding=3>
		...
		<td   align="center" valign="middle"><h5 style="color:#000">Номер</td> 
		<td   align="center" valign="middle"><h5 style="color:#000">Название</td> 
		<td   align="center" valign="middle"><h5 style="color:#000">Клиент</td>     
		<td   align="center" valign="middle"><h5 style="color:#000">Дата</td>	  
		<td   align="center" valign="middle"><h5 style="color:#000">Сроки</td>	                   
		<td   align="center" valign="middle"><h5 style="color:#000">Статус</td>
		<td   align="center" valign="middle"><h5 style="color:#000">Исполнитель</td>                
		<td   align="center" valign="middle"><h5 style="color:#000">Клиент оплатил</td>	                   
		<td   align="center" valign="middle"><h5 style="color:#000">Оплачено</td>
		<td   align="center" valign="middle"><h5 style="color:#000">Описание</td>                                           			        
			</tr>
